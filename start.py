...
message = can.Message(arbitration_id=0x10, data=[0x01, 0x1F, 0x80, 0x08, 0x01, 0x00, 0x00, 0x00], is_extended_id=False)  # creación del mensaje para ejecutar Autostart a 1
